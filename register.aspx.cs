...
public partial class register : System.Web.UI.Page
{
    ...
    protected void btnRegister_Click(object sender, ImageClickEventArgs e)
    {
        ...
        TestSubmission submissionModule6 = pnlPreTestModule6.Controls
                  .BuildSubmissionForModule(6, QuizType.PreTest);
        ...
        response = TestManager.SubmitTest(submissionModule6);
        ...
        //Response.Redirect("~/login" + DataPersistence.SiteLanguagePostfix + ".aspx" + (user.Status == EntityStatus.Active ? "?pending=1" : ""));
