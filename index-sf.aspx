<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/frontend.master" AutoEventWireup="true" CodeFile="index-sf.aspx.cs" Inherits="index_sf" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMain" Runat="Server">
     <div class="homepage-wrapper">
		<div id="col1">
			...
			<p class="caption">
				 Veuillez lire cette brève introduction avant d’entamer ce programme de formation certifié FMC consacré à la 
                sclérose en plaques (SEP) : vous y découvrirez quelques conseils et un peu d’aide pour utiliser au mieux ce 
                site internet.
			</p>
			<h3>
		...
		<div id="col2">
			...
			<div id="affiliations">
                <a href="https://www.multiplesklerose.ch/fr" target="_blank" onclick="window.open('https://www.multiplesklerose.ch/fr', '_blank', 'width=auto, height=auto, left=100,top=100,scrollbars=yes');return false"><img id="Img1" src="~/images/frontend/content/home/home_partner_all_logos-sf.png" alt="logo" runat="server" /></a> 
			</div>
		</div>
	</div>
