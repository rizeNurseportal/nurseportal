...
<%@ Register Src="commoncontrols/learning/benchmarkSurvey-cz.ascx" TagName="benchmarkSurvey" TagPrefix="uc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMain" runat="Server">
    <div class="registrationPage">
        <p>
            Než můžete zahájit studijní program, musíte nejprve registrovat své údaje na webových stránkách. Klikněte prosím na tlačítko 
            „Registrovat“ a registrujte se podle pokynů. 
        </p>
        <p>
            Při dalších návštěvách webových stránek budete vyzván/a k přihlášení s použitím svého uživatelského jména a hesla, 
            vytvořeného během registrace.
        </p>
        <asp:Panel ID="regControls" runat="server">
            <div class="usernamePassword">
                <span class="subheadlines">Uživatelské Jméno / Heslo </span>
                <table class="regdata">
                   <%-- <tr>
                        <td>
                            <span class="tableText">Kód pozvánky</span>
                            <br />
                            <asp:TextBox ID="txtInvitationCode" runat="server"></asp:TextBox>
                            <br />
                            <asp:CheckBox ID="chkInvCode" runat="server" />
                            <span class="tableText">Nemám kód pozvánky</span>
                        </td>
                        <td>
                        </td>
                    </tr>--%>
                    <tr>
                        <td>
                            <span class="tableText">E-mail (uživatelské jméno): </span>
                            <br />
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please enter user name."
                                ...
                                SetFocusOnError="true" ForeColor="Red">*Povinné!</asp:RequiredFieldValidator>
                            <asp:CustomValidator ID="validator" runat="server" ControlToValidate="txtUsername"
                                Display="Dynamic" ErrorMessage="Toto uživatelské jméno již existuje!" ForeColor="Red" SetFocusOnError="true"
                                OnServerValidate="validatorUsername_Validate" ValidationGroup="register"></asp:CustomValidator>
                        </td>
                        <td>
                            <span class="tableText">Heslo: </span>
                            <br />
                    ...
                    <tr>
                        <td>
                            <span class="tableText">Potvrďte e­-mail: </span>
                            <br />
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Please enter confirm email."
                                ...
                                SetFocusOnError="true" ForeColor="Red">*Povinné!</asp:RequiredFieldValidator>
                            <asp:CompareValidator ID="compareValidatorEmail" runat="server" ErrorMessage="E-mail neodpovídá!"
                                ControlToValidate="txtConfirmEmail" ControlToCompare="txtUsername" ValidationGroup="register"
                                Display="Dynamic" SetFocusOnError="true" ForeColor="Red">*E-mail neodpovídá!</asp:CompareValidator>
                        </td>
                        <td>
                            <span class="tableText">Potvrďte heslo: </span>
                            <br />
                            ...
                            <asp:CompareValidator ID="compareValidator1" runat="server" ErrorMessage="Password does not match!"
                                ...
                                Display="Dynamic" SetFocusOnError="true" ForeColor="Red">*Heslo neodpovídá!</asp:CompareValidator>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="personalData">
                <span class="subheadlines">Osobní údaje</span>
                <table class="regdata">
                    <tr>
                        <td>
                            <span class="tableText">Jméno:</span>
                            <br />
                        ...
                        <td>
                            <span class="tableText">Příjmení:</span>
                            <br />
                    ...
                    <tr>
                        <td>
                            <span class="tableText">Adresa, řádek 1: </span>
                            <br />
                        ...
                        <td>
                            <span class="tableText">Město: </span>
                            <br />
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="Please enter city."
                                ...
                                ForeColor="Red">*Povinné!</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <span class="tableText">Adresa, řádek 2: </span>
                            <br />
                            <asp:TextBox ID="txtAddLine2" runat="server" Width="200" MaxLength="200"></asp:TextBox>
                            <br />
                        </td>
                        <td>
                            <span class="tableText">Poštovní směrovací číslo: </span>
                            <br />
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="tableText">Zemì: </span>
                            <br />
                    ...
                    <tr>
                        <td>
                            <span class="tableText">Povolání: </span>
                            <br />
                            <asp:DropDownList ID="ddlProfession" runat="server" Width="150" AutoPostBack="true" OnSelectedIndexChanged="drpProfession_SelectedIndexChanged">
                                <asp:ListItem Text="Sestra - Všeobecná" Value="General"></asp:ListItem>
                                <asp:ListItem Text="Sestra - Neurologie" Value="Neurology"></asp:ListItem>
                                <asp:ListItem Text="Sestra - RS" Value="MS"></asp:ListItem>
                                <asp:ListItem Text="Sestra - Rehabilitace" Value="Rehabilitation"></asp:ListItem>
                                <asp:ListItem Text="Sestra - Práce v komunitě" Value="Community"></asp:ListItem>
                                <asp:ListItem Text="Jiné (prosím uveďte)" Value="Other"></asp:ListItem>
                            </asp:DropDownList>
                    ...
                    <tr>
                        <td>
                            <span class="tableText">Jazyk: </span>
                            <br />
                            <asp:DropDownList ID="ddlLanguage" runat="server" Width="150">
                                <asp:ListItem Text="Angličtina" Value="en"></asp:ListItem>
                                <asp:ListItem Text="čeština" Value="cz"></asp:ListItem>
                                <asp:ListItem Text="holandský" Value="nl"></asp:ListItem>
                                <asp:ListItem Text="francouzština" Value="fr"></asp:ListItem>
                                <asp:ListItem Text="Němec" Value="de"></asp:ListItem>

                                <asp:ListItem Text="italština" Value="it"></asp:ListItem>
                                <asp:ListItem Text="norský" Value="no"></asp:ListItem>
                                <asp:ListItem Text="polština" Value="pl"></asp:ListItem>
                                <asp:ListItem Text="španělština" Value="es"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
                        </td>
            ...
            <div class="shortSurvey">
                <span class="subheadlines">Krátký průzkum</span>
                <table id="shortsurveydata" class="regdata">
                    <tr>
                        <td>
                            <span class="tableText questionNumber">1.</span> 
                            <span class="tableText">Je ve Vaší zemì uznávána specializace RS sestry? </span>
                        </td>
                        <td>
                            <div class="radioYes">
                                <asp:RadioButtonList ID="lstDoesCountryRecognize" runat="server" RepeatDirection="Horizontal"
                                    ...
                                    <asp:ListItem Text="Ano" Value="Yes"></asp:ListItem>
                                    <asp:ListItem Text="Ne" Value="No"></asp:ListItem>
                                </asp:RadioButtonList>
                    ...
                    <tr>
                        <td>
                            <span class="tableText questionNumber">2.</span> 
                            <span class="tableText">Pokládáte se za RS sestru?</span>
                        </td>
                        <td>
                            <div class="radioYes">
                    ...
                    <tr>
                        <td>
                            <span class="tableText questionNumber">3.</span> 
                            <span class="tableText">Jaké procento svého èasu trávíte s pacienty s RS?</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <span class="tableText questionNumber">4.</span> 
                            <span class="tableText">Jaké procento svého času trávíte s jinými pacienty než s pacienty <br />&nbsp;&nbsp;&nbsp;&nbsp;s RS?</span>
                        </td>
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ErrorMessage="Please enter your answer for question 4."
                                ...
                                Display="Dynamic" SetFocusOnError="true" ForeColor="Red">*Povinné!</asp:RequiredFieldValidator>
                    ...
                    <tr>
                        <td>
                            <span class="tableText questionNumber">5.</span> 
                            <span class="tableText">Kolik let již máte kvalifikaci zdravotní sestry? </span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <span class="tableText questionNumber">6.</span> 
                            <span class="tableText">Kolik let ve své praxi pracujete s pacienty s RS? </span>
                        </td>
                        <td>
                            <span class="prctSymbol">&nbsp;&nbsp; </span>
                    ...
                    <tr>
                        <td>
                            <span class="tableText questionNumber">7.</span> 
                            <span class="tableText">Kolika osobám osob s RS v průměru zpravidla poskytujete péči?</span>
                        </td>
                        <td>
                    ...
                    <tr valign="top">
                        <td>
                            <span class="tableText questionNumber">8.</span> 
                            <span class="tableText">Jaká poměrná část osob s RS ve Vaší péči má:</span>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" valign="top" colspan="2">
                            <table cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td>
                                        <span class="tableText">Relaps-remitující RS</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <span class="tableText">Sekundárně
progresivní
RS</span>
                                    </td>
                                    <td>
...
RS</span>
                    ...
                    <tr>
                        <td colspan="2">
                            <span class="tableText questionNumber">9.</span> <span class="tableText">
                                Tento studijní program e‐learningu získal akreditaci od  organizace České asociace sester (ČAS) pro udělování kreditů v programech kontinuálního 
                                <br />&nbsp;&nbsp;&nbsp;&nbsp; odborného vzdělávání. Byl také schválen Mezinárodní radou sester (International Council of Nurses, ICN) pro udělování mezinárodních kreditů v 
                                <br />&nbsp;&nbsp;&nbsp;&nbsp; kontinuálním vzdělávání sester (ICNEC).
</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <span class="tableText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Zvolte prosím certifikáty o kreditech, které potřebujete:</span>
                        </td>
                        <td>
                            <div class="radioYes">
                                <asp:RadioButtonList ID="lstSurveyCertificate" runat="server" RepeatDirection="vertical"
                                    ...
                                    <asp:ListItem Text="ČAS (České)" Value="ČAS"></asp:ListItem>
                                    <asp:ListItem Text="ICN (evropská/mezinárodní)" Value="ICN"></asp:ListItem>
                                </asp:RadioButtonList>
            ...
            <div class="regButton">
                <asp:ImageButton ID="btnRegister" runat="server" ImageUrl="~/images/frontend/content/loginregister/btn_register-cz.png"
        ...
        <asp:Panel ID="regSuccess" runat="server" CssClass="regSuccessPanel" Visible="false">
            <div class="msgThanks">
                Děkujeme Vám za účast v programu Profesionálního vzdělávání pro RS sestry.
                <br />
                <span class="msgThanks msgThanks2nd">Na Váš e-mailový účet byl zaslán ověřovací e-mail.</span>
            </div>
        </asp:Panel>
        <asp:Panel ID="submitData" runat="server" CssClass="regSuccessPanel" Visible="false">
            <div class="msgThanks">
                <b>Žádost byla úspěšně zaslána.</b>
                <br><br />
                Obdržíte informace o přístupu na webové stránky formou e-mailové zprávy.
            </div>
        </asp:Panel>
    </div>
</asp:Content>
