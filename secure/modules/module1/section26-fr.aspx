...
<asp:Content ID="Content3" ContentPlaceHolderID="contentMain" Runat="Server">
    <div class="module1page">
		...
		<div class="icon_summary">
			<ul class="noindent">
				<li><span>La SEP est l’atteinte  neurologique  chronique  la plus fréquente chez les jeunes adultes.</span></li>
				<li><span>La maladie est plus fréquente dans les pays les plus éloignés de l’équateur.</span></li>
				<li><span>Les facteurs ethniques, sexuels, génétiques  et environnementaux  sont susceptibles d’influencer l’incidence de la maladie.</span></li>
				<li><span>Il  y  a  quatre  grandes formes évolutives de  SEP  (SEP RR,  SEP SP,  SEP PP  et  SEP PR)  et  le pronostic peut varier considérablement d’un patient à l’autre.</span> </li>
			</ul>
		</div>
        <br /><br />
