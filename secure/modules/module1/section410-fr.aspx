...
<asp:Content ID="Content3" ContentPlaceHolderID="contentMain" Runat="Server">
    <div class="module1page">
		...
		<div class="icon_reading">
			<p>
				Lectures recommandées<sup>84</sup> : Nicholas R, Young C, and Friede T. Bladder symptoms in multiple sclerosis: a review of pathophysiology and management. 
                <i>Expert Opin Drug Saf</i> 2010; 9(6): 905–15.
			</p>
		</div>
		<p>
			Selon  les  estimations,  64  à  68 %  des  patients  atteints  d’une  SEP  signalent une augmentation des urgences mictionnelles pendant la journée, une hausse de la fréquence des mictions, une incontinence urinaire ou des retards de miction.
		</p>
