<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/moduleGerman.master" AutoEventWireup="true" CodeFile="clinicalcases-at.aspx.cs" Inherits="secure_modules_module1_clinicalcases_at" %>
    ...
    <div class="module1page">
        <div class="cliniciancase">
            ...
            <asp:Panel ID="fourthScreen" runat="server" CssClass="clinicianscreen">
                ...
                <div class="contbutton">
                    <asp:ImageButton ID="ImageButton1" runat="server" CssClass="btncont" ImageUrl="~/images/frontend/global/btn_continue_on-de.png"
