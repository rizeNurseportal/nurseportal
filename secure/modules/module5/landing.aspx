...
<asp:Content ID="Content3" ContentPlaceHolderID="contentMain" Runat="Server">
    <div class="module5page landingpage">
        ...
        <div class="icon_objectives">
            ...
            <ul>
                <li><span>Evaluate how to effectively counsel people with MS toward realistic expectations 
                    with achievable action plans</span></li>
                <li><span>Describe the social and emotional impact of caregiving and the importance 
                    of establishing a strong relationship with the carer</span></li>
                <li><span>Evaluate the importance of patient and family education</span></li>
                <li><span>List and apply strategies for effective patient education</span></li>
                <li><span>Describe the role of the multidisciplinary team in MS care</span></li>
                <li><span>Identify how MS can impact upon the emotional well-being of the person 
                    with MS</span></li>
                <li><span>Outline coping and adaptation strategies that can be implemented to 
                    assist the person with MS </span></li>
                <li><span>Implement non-pharmacologic interventions for the management of 
                    common symptoms</span></li>
                <li><span>Outline the MS Nurse’s role in symptomatic assessment and management</span></li>
                <li><span>List primary care management steps for males and females that should 
                    occur in conjunction with MS treatment</span></li>
                <li><span>Outline the current data on management issues in pregnant and 
                    breastfeeding women with MS</span></li>
                <li><span>Evaluate the impact of the menstrual cycle and menopause on 
                    females with MS</span></li>
                <li><span>Discuss the sexual health issues in males and females with MS</span></li>
                <li><span>Describe and apply strategies for the assessment of sexuality</span></li>
                <li><span>Assess the economic, social and emotional impact of living with MS</span></li>
                <li><span>Outline factors that promote and hinder employment of people with MS</span></li>
                <li><span>Describe the impact that a diagnosis of MS can have on the family unit</span></li>
                <li><span>Discuss strategies to improve lifestyle of people with MS</span></li>
                <li><span>Outline the competencies that make up the role of the MS Nurse</span></li>
                <li><span>Indicate the value of the MS Nurse in optimising patient support</span></li>
            </ul>
        </div>
        <h2>
            Target Audience</h2>
        <p>
            This activity has been developed to meet the educational needs of nurses 
            who have an interest in optimising the management of people with MS.
        </p>
   <h2>
            Accreditation</h2>
        <br />
