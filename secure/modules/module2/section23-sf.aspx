...
<asp:Content ID="Content3" ContentPlaceHolderID="contentMain" Runat="Server">
     <div class="module2page">
        ...
        <p>
            Une enquête menée auprès de personnes atteintes de SEP a conclu que 21 % d’entre elles ont présenté un SCI de type névrite optique, 46 % une association de signes et symptômes témoignant d’une atteinte des voies longues (déficits moteurs ou sensoriels), 10 % un syndrome du tronc cérébral et 23 % des anomalies multifocales<sup>4-6</sup>.
        </p>

        <p>
            Les patients qui ont un syndrome cliniquement isolé peuvent, ou non, finir par développer une SEP cliniquement définie. Il faut noter qu’un SCI n’est pas un 
            critère de diagnostic de la SEP. Toutefois, des études ont montré que si un SCI s’accompagne de lésions cérébrales détectées en IRM qui correspondent à des 
            lésions typiques de SEP, le risque d’un deuxième événement neurologique est élevé. Par contre, les individus ne présentant pas de lésions détectables en IRM ont un risque 
