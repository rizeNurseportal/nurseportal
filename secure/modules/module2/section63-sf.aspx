...
<asp:Content ID="Content3" ContentPlaceHolderID="contentMain" Runat="Server">
    <div class="module2page">
        ...
        <div class="nursetip">
            ...
            <p>
                Quelle réponse pourriez-vous donner à une personne qui se montre inquiète ou anxieuse quant à l’évolution de sa maladie et qui vous pose des questions sur les éventuelles invalidités qu’elle provoque ? Exemples de question : « Vais-je me retrouver dans un fauteuil roulant ? », « La maladie va-t-elle écourter ma vie ? »
            </p>
        </div>
        <div id="nursetippopup1" class="nursetippopup">
            <p> 
                La plupart des patients sont anxieux lorsqu’ils entendent leur diagnostic. Ils craignent l’éventualité d’un handicap et de leur décès. 
                La plupart affirment ne pas vouloir être une charge pour leur famille. La SEP est imprévisible, qu’il s’agisse de son évolution générale, du type et de la 
                sévérité des symptômes ressentis par chacun ou encore de son évolution à long terme. Son pronostic incertain est difficile à gérer. De nombreux malades demandent s’il existe un moyen d’identifier les « déclencheurs » qui aggravent la maladie, mais les preuves permettant d’identifier un événement ou des circonstances spécifiques sont vraiment très rares. Certains éléments donnent à penser que les événements stressants, notamment un grave choc émotionnel, peuvent favoriser une détérioration de l’état du patient mais ils sont controversés. 
            </p>
            <p> 
        ...
        <p>    
            ...
            influentes sont prises en compte, bien que certaines études de l’histoire naturelle suggèrent que le sexe masculin puisse constituer un facteur négatif dans le cas 
            de la SEP-RR et de la SEP-SP<sup>114</sup>. Les hommes sont davantage que les femmes susceptibles de connaître une progression rapide de la maladie, mais les 
            femmes enregistrent un taux plus élevé de poussées ; les taux d’incapacité cumulée sont comparables chez l’homme et chez la femme<sup>142</sup>.
        </p>
        <p>
