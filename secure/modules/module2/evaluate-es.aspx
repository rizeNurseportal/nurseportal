...
<asp:Content ID="Content1" ContentPlaceHolderID="contentBreadcrumb" runat="Server">
    ...
    Presentación Clínica \ Evaluar Módulo
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentMain" runat="Server">
    <div class="module2page">
        <h1>
            Evaluación del Programa: Módulo 2</h1>
        <asp:Panel ID="pnlEvaluationForm" runat="server" CssClass="evaluation-form">
            ...
            <uc1:evaluationGroupRating ID="group1" runat="server">
                ...
                <Questions>
                    <evaluationquestioncontrol>Explicar qué significa el término "síndrome clínicamente  
                                               aislado"</evaluationquestioncontrol>
                    <evaluationquestioncontrol>Identificar los diferentes tipos de EM y conocer su historia   
                                               natural y progresión</evaluationquestioncontrol>
                    <evaluationquestioncontrol>Describir la variabilidad de la evolución clínica de la EM   
                                               y la discapacidad resultante</evaluationquestioncontrol>
                    <evaluationquestioncontrol>Determinar la naturaleza y el impacto de algunos de los   
                                               síntomas más comunes detectados en pacientes con EM</evaluationquestioncontrol>
                    <evaluationquestioncontrol>Describir los enfoques empleados para identificar   
                                               algunos de los síntomas</evaluationquestioncontrol>
                    <evaluationquestioncontrol>Describir las características de una recaída de EM</evaluationquestioncontrol>
                    <evaluationquestioncontrol>Identificar las preguntas clave para realizar a un   
                                               paciente con EM que considera que podría estar   
                                               experimentando una recaída</evaluationquestioncontrol>
                    <evaluationquestioncontrol>Ayudar a un paciente con EM a diferenciar la fluctuación   
                                               de los síntomas, la recaída y la infección potencial, y a comprender los factores desencadenantes</evaluationquestioncontrol>
                    <evaluationquestioncontrol>Describir las diferencias entre la EM de inicio en edad   
                                               adulta y temprana</evaluationquestioncontrol>
                    <evaluationquestioncontrol>Definir la EM de comienzo tardío</evaluationquestioncontrol>
                    <evaluationquestioncontrol>Describir otras variaciones menos comunes de la EM</evaluationquestioncontrol>
                    <evaluationquestioncontrol>Especificar los factores de avance de la enfermedad   
                                               y los síntomas que predicen el resultado a largo plazo</evaluationquestioncontrol>
                </Questions>
            ...
            <uc1:evaluationGroupFreeText ID="EvaluationGroupFreeText2" runat="server">
                <GroupName>MODULE CONTENT</GroupName>
                <GroupQuestion>Describa dos formas en las que cambiará el ejercicio de su   
                                profesión como resultado de haber participado en este módulo:</GroupQuestion>
                <Questions>
