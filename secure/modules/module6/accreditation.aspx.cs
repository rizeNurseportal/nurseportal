...
public partial class secure_modules_module6_accreditation : ModulePage
{
    ...
    private void GuardState()
    {
        ...
        else if (TestManager.ModulePassed(DataPersistence.UserID, 6))
        {
            // this module is complete, but not all modules
            pnlPages.Visible = false;
            pnlCompleted.Visible = true;
        }
        else if (TestManager.ModuleLocked(DataPersistence.UserID, 6))
        {
	...
	protected void btnSubmit_Click(object sender, EventArgs e) {
		...
		TestSubmission submission = pnlPage1.Controls
				.BuildSubmissionForModule(6, QuizType.AccreditedTest)
        ...
        TestSubmission postTest = pnlPostTestModule1.Controls.BuildSubmissionForModule(6, QuizType.PostTest);
