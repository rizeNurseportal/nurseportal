...
<asp:Content ID="Content3" ContentPlaceHolderID="contentMain" Runat="Server">
     <div class="module4page">
        ...
        <p>
            Une bonne prise en charge de ce type de dysfonctionnement commence par un examen chez un professionnel de la santé qualifié et implique une collaboration 
            permanente avec le patient en vue de mettre en place des stratégies qui répondent à ses besoins particuliers. Plusieurs facteurs peuvent aggraver 
            la constipation, entre autres une faible mobilité, une réduction volontaire de l’ingestion de liquides en vue de réduire l’incontinence urinaire, 
            les médicaments anticholinergiques permettant de traiter des symptômes vésicaux et de mauvaises habitudes alimentaires. L’incontinence fécale peut 
            être provoquée par une diminution des sensations au niveau du périnée et du rectum, une faiblesse des contractions sphinctériennes, un fécalome, ou une combinaison de ces facteurs.
        </p>
           <a id="3" name="3"></a>
        <h3>4.7.3 Prise en charge</h3>
        <p>
            Pour traiter la dysfonction intestinale dans un contexte de SEP, on recommande généralement de suivre un régime riche en fibres, de consommer beaucoup de 
            liquide, de respecter des habitudes régulières pour aller à la selle et de faire des lavements ou de prendre des laxatifs, mais les preuves à l’appui de 
            l’efficacité de ces mesures sont faibles<sup>160</sup>. Un traitement pharmacologique à long terme destiné à prévenir un dysfonctionnement intestinal est à déconseiller, sans compter qu’il peut provoquer une accoutumance, mais il n’est pas toujours possible de l’éviter<sup>161</sup>.
        </p>
        <p>
