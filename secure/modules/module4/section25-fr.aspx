     ...
     <div class="module4page">
		...
		<div class="icon_summary">
			<ul class="noindent">
                ...
                <li><span>Il peut s’agir d’une gestion des symptômes ou, en cas de poussée/exacerbation aiguë, d’un traitement stéroïdien à fortes doses (par intraveineuse ou par voie orale). </span></li>
			</ul>
		</div>
        <br /><br />
        ...
        Section="2" SubSection="5">
            <LearningPointText>
                Comment pouvez-vous faire en sorte que des patients qui subissent une rechute, y compris les patients ambulatoires, reçoivent une aide appropriée en 
                plus de leur traitement stéroïdien ?
            </LearningPointText>
        </uc1:reflectiveLearning>
         <p>
             D'autres rechutes peuvent constituer un défilé de deuils répétés, de nouvelles pertes et angoisses ; comme soutiendriez-vous un patient qui ressentirait 
             de tels sentiments ?
         </p>
