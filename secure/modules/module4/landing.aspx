...
<asp:Content ID="Content3" ContentPlaceHolderID="contentMain" Runat="Server">
    <div class="module4page landingpage">
        <h1 class="icon_module">
            MODULE 4:
            <br />
            Treating Multiple Sclerosis<br />
        </h1>
        <h2>
            CME Module Title</h2>
        <p>
        ...
        <div class="icon_objectives">
            ...
            <ul>
                <li><span>Explain the impact of relapses on an individual patient</span></li>
                <li><span>Explain the management of a patient suffering their first MS attack</span></li>
                <li><span>Describe the management of relapse symptoms</span></li>
                <li><span>Describe the benefits and side effects of steroid therapy.</span></li>
                <li><span>Summarise the DMTs commonly used for people with MS</span></li>
                <li><span>Distinguish between immunomodulators and immunosuppressants</span></li>
                <li><span>Explain the risks and benefits of therapy</span></li>
                <li><span>Explore the role of the MS Nurse in encouraging concordance/adherence</span></li>
                <li><span>Summarise the adverse events of therapy.</span></li>
                <li><span>Summarise the symptoms that people with MS may experience</span></li>
                <li><span>Describe the management of these symptoms.</span></li>
            </ul>
        </div>
        <h2>
            Target Audience</h2>
  ...
  <h2>
        ...
        <p>
            ...
            curriculum for a maximum of 10 credits/education units. On completion of the course
            (i.e. all 5 modules) you will be able to download a Virtual College certificate.
        </p>
        <p>
            Estimated time to complete this module: 10 hours
        </p>
        <h2>
