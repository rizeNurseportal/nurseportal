...
wiederhergestellt wird.</OptionC>
                    ...
                    <uc1:questionMultipleChoice ID="questionMultipleChoice6" runat="server" QuestionNumber="6"
                        ...
                        <OptionA>Idealerweise sollte die Therapie mit einer KMT zumeist so schnell und so früh wie möglich
begonnen werden.</OptionA>
...
potenzielle Vorteile, Risiken und Nebenwirkungen der Behandlung aufzeigen</OptionC>
                        <OptionD>Patienten dazu ermutigen, dass ein Familienmitglied oder eine Pflegekraft  die Injektionen
verabreicht, um ihnen die Angst vor Selbstinjektionen zu nehmen</OptionD>
                    </uc1:questionMultipleChoice>
                    ...
                    <uc1:questionMultipleChoice ID="questionMultipleChoice24" runat="server" QuestionNumber="24"
                        CorrectValue="B">
                        <QuestionText>Welche der folgenden Antworten kann bei MS-Therapie nicht zu einem vermehrten Auftreten von Hautreaktionen an der Einstichstelle führen?
                        </QuestionText>
