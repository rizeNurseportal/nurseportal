...
<asp:Content ID="Content3" ContentPlaceHolderID="contentMain" Runat="Server">
    <div class="module3page">
		...
		<div class="icon_summary">
			<ul class="noindent">
                <li><span>Une poussée, ouattaque ou exacerbation correspond à la survenue de nouveaux symptômes ou signes chez une personne atteinte de SEP, ceux-ci persistant généralement pendant au moins 24 heures.</span></li>
                <li><span>Une poussée peut se caractériser par l’apparition de nouveaux symptômes ou la réapparition d’anciens symptômes :</span>
                    <ul class="lessheight">
                        <li><span>
                ...
                <li><span>L’apparition de nouveaux  signes et/ou symptômes  à la suite d’une élévation  temporaire de la température corporelle ne constitue pas une poussée; un tel épisode est appelé pseudo-poussée.</span>
                    <ul class="lessheight">
        ...
        Section="5" SubSection="3" ControlNumber="1">
            <LearningPointText>
              Quels sont les principaux éléments indiquant que les symptômes ressentis par un patient sont liés à une poussée ?
            </LearningPointText>
