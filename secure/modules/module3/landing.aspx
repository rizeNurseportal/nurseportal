<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/module.master" AutoEventWireup="true" 
        CodeFile="landing.aspx.cs" Inherits="secure_modules_module3_landing" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contentBreadcrumb" Runat="Server">
    Diagnosis and Assessment \ Landing Page
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentMain" Runat="Server">
    <div class="module3page landingpage">
        ...
        <h2>
            CME Module Title</h2>
        <p>
            Diagnosing and Assessing Multiple Sclerosis
        </p>
        <h2>
        ...
        <div class="icon_objectives">
            ...
            <ul>
                ...
                <li><span>Describe the McDonald Criteria in relation to a diagnosis of MS </span></li>
                <li><span>Examine the effects of the 2010 revisions to the McDonald Criteria</span></li>
                <li><span>Explain results from magnetic resonance imaging (MRI) and their relevance to a diagnosis of MS</span></li>
                <li><span>Discuss the importance of the presence of oligoclonal bands in the cerebrospinal fluid (CSF)</span></li>
                <li><span>Describe evoked potential tests and their significance.</span></li>
                <li><span>Identify an MS relapse</span></li>
                <li><span>Differentiate relapse from disease progression and other nonMS related conditions</span></li>
                <li><span>Describe the EDSS, MSFC and the MSSS assessment tools</span></li>
                <li><span>Discuss how these tools assist in monitoring disease progression in MS.</span></li>
            </ul>
        </div>
        <h2>
            Target Audience</h2>
        <p>
            This activity has been developed to meet the educational needs of nurses who have an 
            interest in optimising the management of people with MS.
        </p>
<h2>
            Accreditation</h2>
        <br />
