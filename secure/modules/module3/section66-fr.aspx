...
<asp:Content ID="Content3" ContentPlaceHolderID="contentMain" Runat="Server">
    <div class="module3page">
		...
		<div class="icon_summary">
			<ul class="noindent">
                <li><span>Les outils d’évaluation concernent la progression de la maladie chez les personnes atteintes de SEP.</span></li>
        ...
        Section="6" SubSection="6" ControlNumber="1">
            <LearningPointText>
               Quelles sont les différences entre l’EDSS, le MSFC et le MSSS ?
            </LearningPointText>
        </uc1:reflectiveLearning>
        <uc1:reflectiveLearning ID="reflectiveLearning2" runat="server" Module="3"
        Section="6" SubSection="6" ControlNumber="1">
            <LearningPointText>
                Comment expliqueriez-vous un changement au niveau des scores EDSS ou MSFC pour ce qui concerne la progression de la maladie d’un patient ainsi que ses conséquences sur le degré d’invalidité?
            </LearningPointText>
        </uc1:reflectiveLearning>
