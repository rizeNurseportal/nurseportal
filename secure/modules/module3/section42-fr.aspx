...
<asp:Content ID="Content3" ContentPlaceHolderID="contentMain" Runat="Server">
    <div class="module3page">
        ...
        <p>            
            Le fonctionnement de l’IRM est extrêmement complexe. Pour résumer, l’examen IRM permet de mesurer le comportement d’atomes d’hydrogène (également appelés protons) dans l’eau contenue dans les tissus organiques lorsqu’ils sont exposés à un puissant champ magnétique. La technologie IRM permet de convertir les zones ciblées, notamment des tissus mous, en images 3D et peut aider à définir le type de tissu présent dans ces zones<sup>25</sup>.
        </p>
        <div class="keypoint">
            La technologie IRM permet de convertir les zones ciblées en images 3D.
        </div>
        <p>
            L’IRM est importante pour détecter, avec une grande sensibilité, des anomalies tissulaires macroscopiques chez les personnes atteintes de SEP. La plupart des recherches dans le domaine de la SEP ont été effectuées sur des
        ...
        <div id="deepdivepopup" class="deepdivepopup">
             Plus puissants, les appareils de 3 teslas gagnent actuellement du terrain, tant dans la recherche que dans le milieu hospitalier. Mais leur valeur ajoutée différentielle pour le diagnostic de la SEP n’a toujours pas été établie avec certitude<sup>26</sup>. 
            Les appareils d’une puissance supérieure à 3 teslas sont généralement réservés à la recherche. 
        </div>
        <div class="keypoint">
            L’IRM est importante pour détecter des anomalies tissulaires macroscopiques chez les personnes atteintes de SEP.
        </div>
        <p>
           Des séquences IRM conventionnelles, comme le double écho (dual-echo pour densité de protons et pondération T2), le FLAIR (Fluid-Attenuated Inversion Recovery, technique d'inversion-récupération, ndt) et l’imagerie pondérée en T1 (avec ou sans administration d’un agent de contraste à base de gadolinium)   (Figure 2),   fournissent   des   informations   importantes   pour   aider au diagnostic de  la   SEP, comprendre son histoire naturelle et évaluer l’efficacité d’un traitement.
        </p>
        ...
        <div class="keypoint">
            Des séquences IRM conventionnelles fournissent des informations importantes pour aider au diagnostic de la SEP, comprendre son histoire naturelle et évaluer l’efficacité d’un traitement.
        </div>
        <br />
        ...
        <p>
           On note toutefois un manque de précision dû à la nature pathologique hétérogène des lésions hyperintenses  individuelles.  Dans  ces lésions, un œdème,  une inflammation,  une démyélinisation, une remyélinisation, une gliose et une perte axonale provoquent tous de telles taches blanches sur les images IRM double écho et FLAIR (Figure 3).
        </p>
            ...
            <div class="imagegroup">
                ...
                <table>
                    <tbody>
                        <tr align="left">
                            <td class="tblcaption">
                                Figure 3 – Images IRM montrant des lésions inflammatoires de SEP chez un patient récemment diagnostiqué et présentant un engourdissement au niveau d’une jambe. A : Lésions dans le cerveau, B : Lésion de la moelle épinière responsable de l’engourdissement
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <p>
            À gauche, une IRM du cerveau d’un homme de 35 ans atteint d’une SEP récurrente-rémittente révèle de multiples lésions avec hypersignal T2 et une grande lésion au niveau de la substance blanche. L’image de droite montre la moelle épinière cervicale d’une femme de 27 ans : la flèche indique une plaque de démyélinisation de sclérose en plaques.
        </p>
        <p>
        ...
        <div id="deepdivepopup2" class="deepdivepopup">
            <p>
                <b>Des techniques d’imagerie " non conventionnelles "</b> peuvent aider à mieux comprendre la physiopathologie de la SEP ; elles ont contribué à montrer les dégradations subies par le tissu cérébral d’apparence soi-disant " normale ". 
                <i>La mesure du volume cérébral</i>(mesure  de l’atrophie) est généralement  considérée  comme  une technique  non conventionnelle,  mais de telles mesures ont d’ores et déjà été utilisées dans de nombreux essais cliniques ainsi que dans des hôpitaux et sont en passe de devenir " conventionnelles ". Le Tableau 6 énumère les techniques non conventionnelles  les plus pertinentes mais aussi ce qu’elles  peuvent  suggérer sur la physiopathologie  de la SEP,  particulièrement  sur les dégradations  observées  en dehors  des lésions. Le Tableau 7 énumère quant à lui les avantages et les inconvénients des techniques non conventionnelles.
            </p>
            <div class="module3page">
                <table>
                    <thead>
