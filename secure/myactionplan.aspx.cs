...
public partial class myactionplan : BasePage {
	protected int CurrentModule {
		get {
            ...
            {
                // set default
                module = Convert.ToInt32(Session["Key"]);
                ViewState["module"] = Convert.ToInt32(Session["Key"]);
            }
	...
	private void RefreshDisplay() {
		...
		switch (CurrentModule) {
			...
			case 5:
				...
				break;
            case 6:
                litModuleNameBreadCrumb.Text = "Module6Breadcrumb".TranslateWith("MyActionPlan");
                litModuleNameHeader.Text = "Module6Header".TranslateWith("MyActionPlan");
                break;
			default:
				break;
		}
	...
	protected void rptPoints_ItemDataBound(object source, RepeaterItemEventArgs e) {
