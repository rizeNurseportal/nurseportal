        ...
        <asp:Panel ID="regControls" runat="server">
            ...
            <div class="shortSurvey">
                ...
                <table id="shortsurveydata" class="regdata">
                    ...
                    <tr>
                        <td>
                            <span class="tableText questionNumber">7.</span> <span class="tableText">De combien de personnes atteintes de SEP vous occupez-vous en même temps ?	
  Options présentées dans un menu déroulant  </span>
                        </td>
                        <td>
...
La distribution de la SEP semble sans rapport avec la situation géographique et la génétique.</i>
            ...
            <i>La grossesse va accélérer l’évolution de la SEP</i>
                                ...
                                <uc1:questionPreTest ID="questionPreTest10" runat="server" CorrectValue="A" QuestionNumber="2" Randomize="false" ValidationGroup="register" RequiredMessage="*Required!">
                                    <QuestionTag></QuestionTag>
                                    <QuestionText>9.10 Dans quelle mesure vous sentez-vous capable de concevoir un programme de traitement personnalisé pour vos patients atteints de SEP ?
                                    </QuestionText>
                                    <OptionA>Not at all confident</OptionA>
                                    <OptionB>Somewhat confident</OptionB>
                                    <OptionC>Neutral</OptionC>
