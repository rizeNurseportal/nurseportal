                    ...
                    <tr>
                        <td>
                            ...
                            <asp:DropDownList ID="ddlProfession" runat="server" Width="150" AutoPostBack="true" OnSelectedIndexChanged="drpProfession_SelectedIndexChanged">
                                <asp:ListItem Text="Verpleegster - Algemeen" Value="Algemeen"></asp:ListItem>
                                <asp:ListItem Text="Verpleegster - Neurologie" Value="Neurologie"></asp:ListItem>
                                <asp:ListItem Text="Verpleegster - SM" Value="SM"></asp:ListItem>
                                <asp:ListItem Text="Verpleegster - Rehabilitatie" Value="Rehabilitatie"></asp:ListItem>
                                <asp:ListItem Text="Verpleegster - Gemeenschap" Value="Gemeenschap"></asp:ListItem>
                                <asp:ListItem Text="Andere ( gelieve te specificeren )" Value="Andere"></asp:ListItem>
                            </asp:DropDownList>
                        ...
                        <td>
                            <div class="radioYes">
                                <asp:RadioButtonList ID="lstDoesCountryRecognize" runat="server" RepeatDirection="Horizontal"
                                    ...
                                    <asp:ListItem Text="Nee" Value="Nee"></asp:ListItem>
                                </asp:RadioButtonList>
...
                                 van de praktijk heb je besteed het zien van MS-patiënten? </span>
                    ...
                    <tr>
                        <td>
                            <span class="tableText questionNumber">7.</span> <span class="tableText">Voor hoeveel MS-patiënten zorgt u gemiddeld gedurende bv. één maand?  drie maanden? één jaar</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td align="left" valign="top" colspan="2">
                            <table cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td>
                                        <span class="tableText">Terugkerende remitting MS</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <span class="tableText">Secundair progressieve MS</span>
                                    </td>
                                    <td>
            ...
            <i>Zwangerschap versnelt het verloop van MS.</i>
                                ...
                                <uc1:questionPreTest ID="questionPreTest10" runat="server" CorrectValue="A" QuestionNumber="2" Randomize="false" ValidationGroup="register" RequiredMessage="*Required!">
                                    <QuestionTag></QuestionTag>
                                    <QuestionText>Hoe zeker voelt u zich om een individueel aangepast zorgplan op te stellen voor uw MS-patiënten?
