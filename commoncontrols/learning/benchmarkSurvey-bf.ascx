<%@ Control Language="C#" AutoEventWireup="true" CodeFile="benchmarkSurvey-bf.ascx.cs" Inherits="commoncontrols_learning_benchmarkSurvey_bf" %>
...
<div class="benchmarkingSurveyContainer">
    ...
    <p>
        <b>4.</b>
        <asp:Literal ID="litQuestion4" runat="server">
            Quel est votre niveau de connaissance et de compétence vous permettant de fournir une sensibilisation et des conseils spécialisés aux personnes<br />&nbsp;&nbsp;&nbsp;&nbsp; atteintes de SEP ?
    ...
    <p>
        <b>5.</b>
        <asp:Literal ID="litQuestion5" runat="server">
            Avez-vous suivi une formation, une sensibilisation ou un programme d’accompagnement adéquat(e) qui vous aide dans votre fonction au quotidien <br />&nbsp;&nbsp;&nbsp; Si la réponse est non, veuillez indiquer pour quelles raisons
