<%@ Control Language="C#" AutoEventWireup="true" CodeFile="learningQuestions-el.ascx.cs" Inherits="commoncontrols_learning_learningQuestions_el" %>
         ...
         $(function () {
             $('#btnSubmit').click(function () {
                 ...
                 if ($('#rdoAnswer' + crtanswer).is(':checked')) {
                     var crtmsgtext = '<div class="congratstext">Συγχαρητήρια, answer ' + crtanswer + ' is correct! </div>';
                     ...
                     var wrngmsgtext = '<div class="congratstext">Η απάντηση ' + ansnumber + ' είναι λανθασμένη! </div>';
                     wrngmsgtext += '<div class="ansincongtmsg">';
                     wrngmsgtext += '<div class="crtanssuggest"> Απάντηση ' + crtanswer + ' είναι η σωστή. </div>';
                ...
                <tr>
                    <td>      
                        ...
                        <asp:ImageButton ID="btnSubmit" runat="server"  CssClass="queseubmit"
                            ImageUrl="~/images/frontend/global/btn_submit_on-el.png" ClientIDMode="Static" /> 
