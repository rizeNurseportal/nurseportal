<%@ Control Language="C#" AutoEventWireup="true" CodeFile="learningQuestions-nl.ascx.cs" Inherits="commoncontrols_learning_learningQuestions_nl" %>
    ...
    $(function () {
        $('#btnSubmit').click(function () {
            ...
            if ($('#rdoAnswer' + crtanswer).is(':checked')) {
                var crtmsgtext = '<div class="congratstext">Gefeliciteerd, antwoord ' + crtanswer + ' is juist! </div>';
                ...
                var wrngmsgtext = '<div class="congratstext">antwoord ' + ansnumber + ' onjuist! </div>';
                wrngmsgtext += '<div class="ansincongtmsg">';
                wrngmsgtext += '<div class="crtanssuggest"> antwoord ' + crtanswer + ' zou het juiste antwoord te zijn. </div>';
                ...
                <tr>
                    <td>      
                        ...
                        <asp:ImageButton ID="btnSubmit" runat="server"  CssClass="queseubmit"
                            ImageUrl="~/images/frontend/global/btn_submit_on-nl.png" ClientIDMode="Static" /> 
