...
This user control is used for new Checl Point learning questions.
Created By: Narendra Kumar Mallik
Created On: 17th December, 2012
*******************************************************************************************--%>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="learningQuestions.ascx.cs" 
        Inherits="commoncontrols_learning_learningQuestions" %>
         ...
         $(function () {
             $('#btnSubmit').click(function () {
                 ...
                 if ($('#rdoAnswer' + crtanswer).is(':checked')) {
                     var crtmsgtext = '<div class="congratstext">Congratulations, answer ' + crtanswer + ' is correct! </div>';
                     ...
                     var wrngmsgtext = '<div class="congratstext">Answer ' + ansnumber + ' is incorrect! </div>';
                     wrngmsgtext += '<div class="ansincongtmsg">';
                     wrngmsgtext += '<div class="crtanssuggest"> Answer ' + crtanswer + ' would be the correct answer. </div>';
                ...
                <tr>
                    <td>      
                        ...
                        <asp:ImageButton ID="btnSubmit" runat="server"  CssClass="queseubmit"
                            ImageUrl="~/images/frontend/global/btn_submit_on.png" ClientIDMode="Static" /> 
