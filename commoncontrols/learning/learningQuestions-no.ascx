<%@ Control Language="C#" AutoEventWireup="true" CodeFile="learningQuestions-no.ascx.cs" Inherits="commoncontrols_learning_learningQuestions_no" %>
    ...
    $(function () {
        $('#btnSubmit').click(function () {
            ...
            if ($('#rdoAnswer' + crtanswer).is(':checked')) {
                var crtmsgtext = '<div class="congratstext">Gratulerer, svar  ' + crtanswer + ' er Riktig ! </div>';
                ...
                var wrngmsgtext = '<div class="congratstext">svar ' + ansnumber + ' er feil! </div>';
                wrngmsgtext += '<div class="ansincongtmsg">';
                wrngmsgtext += '<div class="crtanssuggest"> svar ' + crtanswer + ' er Riktig svar. </div>';
                ...
                <tr>
                    <td>      
                        ...
                        <asp:ImageButton ID="btnSubmit" runat="server"  CssClass="queseubmit"
                            ImageUrl="~/images/frontend/global/btn_submit_on-no.png" ClientIDMode="Static" /> 
