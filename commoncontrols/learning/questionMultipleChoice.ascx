<%@ Control Language="C#" AutoEventWireup="true" CodeFile="questionMultipleChoice.ascx.cs"
	Inherits="commoncontrols_learning_questionMultipleChoice" %>
<div class="quizQuestion">
	...
	<p>
		<asp:RadioButtonList ID="lstOptions" runat="server" CssClass="multiple-choice-list">
		</asp:RadioButtonList>
	</p>
</div>
