<%@ Control Language="C#" AutoEventWireup="true" CodeFile="benchmarkSurvey-bn.ascx.cs" Inherits="commoncontrols_learning_benchmarkSurvey_bn" %>
...
<div class="benchmarkingSurveyContainer">
    ...
    <table>
        ...
        <tr>
            <td>
                <asp:Literal ID="litQuestion1x4" runat="server">Therapeutische behandelingen en management van de opklakkeringen</asp:Literal>
            </td>
            <td>
