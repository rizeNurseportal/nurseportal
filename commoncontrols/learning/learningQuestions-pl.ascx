<%@ Control Language="C#" AutoEventWireup="true" CodeFile="learningQuestions-pl.ascx.cs" Inherits="commoncontrols_learning_learningQuestions_pl" %>
     ...
     $(function () {
         $('#btnSubmit').click(function () {
             ...
             if ($('#rdoAnswer' + crtanswer).is(':checked')) {
                 var crtmsgtext = '<div class="congratstext">Gratulacje, odpowiedź ' + crtanswer + ' Jest poprawne! </div>';
                 ...
                 var wrngmsgtext = '<div class="congratstext">odpowiedź ' + ansnumber + ' jest nieprawidłowe! </div>';
                 wrngmsgtext += '<div class="ansincongtmsg">';
                 wrngmsgtext += '<div class="crtanssuggest"> odpowiedź ' + crtanswer + ' byłaby poprawna odpowiedź. </div>';
                ...
                <tr>
                    ...
                    <td valign="middle">
                        <div  class="questionradio">
                            ...
                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="rdoAnswer1" runat="server" ErrorMessage="*wymagany"></asp:RequiredFieldValidator>--%>
                        </div>
                    ...
                    <td>
                        <div  class="questionradio">
                            <asp:RadioButton ID="rdoAnswer2" runat="server"  
                                GroupName="QuestionOption"  ClientIDMode="Static" />
                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="rdoAnswer2" runat="server" ErrorMessage="*wymagany"></asp:RequiredFieldValidator>--%>
                        </div>
                        ...
                        <asp:Panel ID="pnlAnswer3" runat="server" Visible="false">                
                            <div  class="questionradio">
                                <asp:RadioButton ID="rdoAnswer3" runat="server" 
                                    GroupName="QuestionOption"   ClientIDMode="Static" />
                               <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="rdoAnswer3" runat="server" ErrorMessage="*wymagany"></asp:RequiredFieldValidator>--%>
                            </div>                            
                        ...
                        <asp:Panel ID="pnlAnswer4" runat="server" Visible="false">
                            <div  class="questionradio">
                                <asp:RadioButton ID="rdoAnswer4" runat="server" 
                                    GroupName="QuestionOption"   ClientIDMode="Static" />
                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="rdoAnswer4" runat="server" ErrorMessage="*wymagany"></asp:RequiredFieldValidator>--%>
                            </div>
                ...
                <tr>
                    <td>      
                        <asp:Panel ID="pnlAnswer5" runat="server" Visible="false">
                            ...
                            <div  class="questionradio">
                                <asp:RadioButton ID="rdoAnswer5" runat="server" 
                                    GroupName="QuestionOption"  ClientIDMode="Static" />
                               <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="rdoAnswer5" runat="server" ErrorMessage="*wymagany"></asp:RequiredFieldValidator>--%>
                            </div>
                        ...
                        <asp:ImageButton ID="btnSubmit" runat="server"  CssClass="queseubmit"
                            ImageUrl="~/images/frontend/global/btn_submit_on-pl.png" ClientIDMode="Static" /> 
                                                    
                    </td>
                </tr>
            </tbody>
        </table>
       <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="btnSubmit"  ValidationGroup="questionoption" runat="server" ErrorMessage="*wymagany"></asp:RequiredFieldValidator>--%>
