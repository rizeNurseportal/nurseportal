<%@ Control Language="C#" AutoEventWireup="true" CodeFile="learningQuestions-fr.ascx.cs" Inherits="commoncontrols_learning_learningQuestions_fr" %>
     ...
     $(function () {
         $('#btnSubmit').click(function () {
             ...
             if ($('#rdoAnswer' + crtanswer).is(':checked')) {
                 var crtmsgtext = '<div class="congratstext">Félicitations, répondre ' + crtanswer + ' est correcte! </div>';
                 ...
                 var wrngmsgtext = '<div class="congratstext">Répondre ' + ansnumber + ' est inexact! </div>';
                 wrngmsgtext += '<div class="ansincongtmsg">';
                 wrngmsgtext += '<div class="crtanssuggest"> Répondre ' + crtanswer + ' serait la bonne répondre. </div>';
                ...
                <tr>
                    <td>      
                        ...
                        <asp:ImageButton ID="btnSubmit" runat="server"  CssClass="queseubmit"
                            ImageUrl="~/images/frontend/global/btn_submit_on-fr.png" ClientIDMode="Static" /> 
