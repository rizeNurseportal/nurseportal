<%@ Control Language="C#" AutoEventWireup="true" CodeFile="learningQuestions-ro.ascx.cs" Inherits="commoncontrols_learning_learningQuestions_ro" %>
         ...
         $(function () {
             $('#btnSubmit').click(function () {
                 ...
                 if ($('#rdoAnswer' + crtanswer).is(':checked')) {
                     var crtmsgtext = '<div class="congratstext">Felicitări, răspunsul ' + crtanswer + ' este corect! </div>';
                     ...
                     var wrngmsgtext = '<div class="congratstext">Răspunsul ' + ansnumber + ' este incorect! </div>';
                     wrngmsgtext += '<div class="ansincongtmsg">';
                     wrngmsgtext += '<div class="crtanssuggest"> Răspunsul ' + crtanswer + ' este cel corect. </div>';
                ...
                <tr>
                    <td>      
                        ...
                        <asp:ImageButton ID="btnSubmit" runat="server"  CssClass="queseubmit"
                            ImageUrl="../../images/frontend/global/btn_submit_on-ro.png" ClientIDMode="Static" /> 
