...
<%@ Register Src="~/commoncontrols/learning/benchmarkSurvey-fr.ascx" TagName="benchmarkSurvey" TagPrefix="uc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMain" runat="Server">
    <div class="registrationPage">
        <p>
            Vous devez d'abord enregistrer vos coordonnées sur le site avant de pouvoir commencer la formationcurriculum. Se il vous plaît cliquer sur le 
            bouton "Inscription" et suivez les instructions àterminer le processus d'inscription. 
        ...
        <asp:Panel ID="regControls" runat="server">
                ...
                <table class="regdata">
                   <%-- <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="tableText">Confirmer votre mot de passe</span>
                            <br />
            ...
            <div class="personalData">
                ...
                <table class="regdata">
                    ...
                    <tr>
                        <td>
                            <span class="tableText">La Langue: </span>
                            <br />
            ...
            <div class="shortSurvey">
                ...
                <table id="shortsurveydata" class="regdata">
                    <tr>
                        <td>
                            <span class="tableText questionNumber">1.</span> <span class="tableText">Votre pays reconnaît-il le traitement de la SEP comme l’une des<br />
                                &nbsp;&nbsp;&nbsp;&nbsp; spécialités en soins infirmiers ? </span>
                        </td>
                        <td>
                            <div class="radioYes">
                    ...
                    <tr>
                        <td>
                            <span class="tableText questionNumber">2.</span> <span class="tableText">Vous considérez-vous comme un infirmier spécialisé dans le<br />
                                &nbsp;&nbsp;&nbsp;&nbsp; traitement de la SEP ?	 </span>
                        </td>
                        <td>
                            <div class="radioYes">
                    ...
                    <tr>
                        <td>
                            <span class="tableText questionNumber">3.</span> <span class="tableText">Quel pourcentage de votre temps consacrez-vous à des patients<br />
                                &nbsp;&nbsp;&nbsp;&nbsp; atteints de SEP ? </span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <span class="tableText questionNumber">4.</span> <span class="tableText">Quel pourcentage de votre temps consacrez-vous à des patients qui<br />
                                &nbsp;&nbsp;&nbsp;&nbsp; ne sont pas atteints de SEP ?</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <span class="tableText questionNumber">6.</span> <span class="tableText">Depuis combien d’années recevez-vous des patients atteints<br />
                                &nbsp;&nbsp;&nbsp;&nbsp; de SEP ? </span>
                        </td>
                        <td>
                            <span class="prctSymbol">&nbsp;&nbsp; </span>
                    ...
                    <tr>
                        <td>
                            <span class="tableText questionNumber">7.</span> <span class="tableText">De combien de personnes atteintes de SEP vous occupez-vous en<br />
                                &nbsp;&nbsp;&nbsp;&nbsp; même temps ?	Options présentées dans un menu déroulant  </span>
                        </td>
                        <td>
                    ...
                    <tr valign="top">
                        <td>
                            <span class="tableText questionNumber">8.</span> <span class="tableText">Parmi les personnes atteintes de SEP dont vous vous occupez,<br />
                                &nbsp;&nbsp;&nbsp; quel pourcentage est atteint de :Options présentées dans un menu<br />
                                &nbsp;&nbsp;&nbsp; déroulant </span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <span class="tableText questionNumber">9.</span> <span class="tableText">Il a également été validé par l’International Council of Nurses (ICN) pour l’octroi d’International Continuing Nursing Education Credits (ICNEC).       </span>
                        </td>
                    </tr>
                    <%--<tr>
                        <td>
            ...
            <asp:Panel ID="pnlPreTest" runat="server" CssClass="shortSurvey">
                <span class="subheadlines">Confidant</span>
                <table class="regpretest">
                    <tr>
                        <td>
