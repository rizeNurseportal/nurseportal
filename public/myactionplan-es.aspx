<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/frontend.master" AutoEventWireup="true" CodeFile="myactionplan.aspx.cs" Inherits="public_myactionplan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMain" runat="Server">
    ...
    <asp:Panel ID="pnlNoResults" runat="server">
      <p>No puntos de aprendizaje reflexivo han sido incluidas en este módulo. Por favor visite el módulo y la 
        entrada de ellos durante todo el contenido del módulo. </p>
