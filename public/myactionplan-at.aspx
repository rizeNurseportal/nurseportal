<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/frontend.master" AutoEventWireup="true"
    CodeFile="myactionplan.aspx.cs" Inherits="public_myactionplan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMain" Runat="Server">
    ...
    <p>
        Im Verlauf dieses Ausbildungslehrplans stoßen Sie auf reflektierende Lernziele,
        die Ihnen dabei helfen sollen, über das eben Erlernte nachzudenken und zu überlegen,
        wie Sie diese Informationen in Ihrer alltäglichen klinischen Praxis anwenden können.
        Unter „Mein Aktionsplan“ finden Sie eine Liste Ihrer Antworten auf diese reflektierenden
        Fragen (nach Modulen geordnet). So können Sie jederzeit wieder darauf zugreifen,
        um Aktionen aufzurufen, die Sie in Ihrer zukünftigen klinischen Praxis umsetzen
        möchten.
    </p>
    <p>
    ...
    <asp:Panel ID="pnlNoResults" runat="server">
        <p>
            Es wurden keine reflektierenden Lernziele für dieses Modul eingegeben. Öffnen Sie
            das Modul und geben Sie diese für den gesamten Modulinhalt ein.</p>
        <p>
            Sie werden anschließend in Ihrem Aktionsplan auf dieser Seite angezeigt.</p>
    </asp:Panel>
</asp:Content>
