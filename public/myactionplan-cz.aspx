...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMain" runat="Server">
    ...
    <h2>
        Úvodní text k akčnímu plánu</h2>
    <p>
    ...
    <asp:Panel ID="pnlNoResults" runat="server">
        <p>
            No reflective learning points have been entered for this module. Please visit the
            module and input them throughout the module content.</p>
        <p>
            They will then appear in your action plan on this page.</p>
    </asp:Panel>
</asp:Content>
