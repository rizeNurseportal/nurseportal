<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/admin.master" AutoEventWireup="true" CodeFile="pretestlist.aspx.cs" Inherits="admin_pretestlist" %>
...
<h1>Pretest Report</h1>

    <telerik:RadComboBox ID="drpReportType" runat="server">
        <Items>
            <telerik:RadComboBoxItem Text="Pre-test" Value="pretest" Selected="true" />
            <telerik:RadComboBoxItem Text="Post-Test" Value="posttest" />
        </Items>
    </telerik:RadComboBox>
    ...
    <telerik:RadComboBox ID="drpModule" runat="server">
        <Items>
            <telerik:RadComboBoxItem Text="(All Modules)" Value="0" />
