<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/frontend.master" AutoEventWireup="true" CodeFile="index-fr.aspx.cs" Inherits="index_fr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMain" Runat="Server">
    <div class="homepage-wrapper">
		<div id="col1">
			...
			<p class="caption">
				Veuillez lire cette brève introduction avant d’entamer ce programme de formation certifié FMC consacré à la sclérose en plaques (SEP) : vous y découvrirez quelques conseils et un peu d’aide pour utiliser au mieux ce site internet.
			</p>
			<h3>
		...
		<div id="col2">
			...
			<div id="affiliations">
				<img src="images/frontend/content/home/home_partner_all_logos-fr.png" alt="" />
			</div>
		</div>
	</div>
