     ...
     <div class="endorsementwrapper">
        ...
        <table cellspacing="0">
            <tbody valign="middle">
                 <tr>
                   <td class="left">
                       <img src="images/frontend/content/endorsement/logo-de.png" alt="" /><br />
                       <a href="https://www.multiplesklerose.ch/de/">www.multiplesklerose.ch/de</a>
                   </td>
                   <td class="right">
                       <p>
                           Die Schweiz. MS Gesellschaft versteht sich in der Schweiz als erste Adresse bei MS und steht Betroffenen, Angehörigen, Fachpersonen, Freiwilligen und Interessierten für Fragen rund um die Krankheit zur Verfügung. Unsere Mission ist:
                       </p>
                       <ul>
                           <li>Förderung und Sicherung der Selbstbestimmtheit MS-Betroffener</li>
                           <li>
                               Förderung und Unterstützung der MS-Forschung
                           </li>
                           <li>
                               Förderung der interdisziplinären Zusammenarbeit
                           </li>
                           <li>Information der Öffentlichkeit und Politik</li>
                           <li>«Heimat» bieten für Betroffene und Angehörige</li>
                           <li>Angebot verschiedener Dienstleistungen</li>
                       </ul>
                   </td>
               </tr>
                 <tr>
