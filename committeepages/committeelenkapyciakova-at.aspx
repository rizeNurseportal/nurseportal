<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/frontendGerman.master" AutoEventWireup="true" CodeFile="committeelenkapyciakova-at.aspx.cs" Inherits="committeepages_committeelenkapyciakova_at" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentMain" Runat="Server">
    <div class="committeebio">
        ...
        <div class="committeebiodescription">
		    ...
		    <p>
                <b>Ausbildung und beruflicher Werdegang:</b>  <br />
                1995-1998 selbstständig (Sekretärin)<br />
                1996-1999 Fachschule für Geburtshilfe und Gesundheit, Prag, Tschechien<br />
                2001-2005: Karls-Universität, Medizinische Fakultät in Hradec Králové – Krankenpflege und Pädagogik<br />
                Seit Mai 2002: Neurologische Abteilung, Allgemeines Lehrkrankenhaus (VFN)
            </p>
            <p>
                <b>Forschungsaktivitäten:</b>  <br />
